            ...
            <>
              ...
              <form onSubmit={handleSubmit((d) => mutation.mutate(d.email))} className="space-y-4">
                <div className="space-y-2">
                  <label htmlFor="email" className="block text-sm text-zinc-300">Email Address</label>
                  <Input
                    id="email"
                    type="email"
              ...
              <Link href="/login" className="flex items-center gap-1 text-sm text-zinc-400 hover:text-white transition-colors">
                Back to sign in <ArrowRight className="w-3.5 h-3.5 mt-px" />
              </Link>
            </>
          )}
