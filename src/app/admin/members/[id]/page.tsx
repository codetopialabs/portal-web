    ...
    <div className="space-y-8">
      ...
      <div className="bg-white border border-zinc-200">
        ...
        <div className="px-6 py-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <p className="font-mono text-xs text-zinc-400 uppercase tracking-widest">Bio</p>
            <p className="font-sans text-sm text-zinc-700">{formatValue(member.bio)}</p>
          </div>
          <div>
            <p className="font-mono text-xs text-zinc-400 uppercase tracking-widest">Discipline</p>
            <p className="font-sans text-sm text-zinc-700">{formatValue(member.discipline)}</p>
          </div>
          <div>
            <p className="font-mono text-xs text-zinc-400 uppercase tracking-widest">
              Experience Level
            </p>
            <p className="font-sans text-sm text-zinc-700">{formatValue(member.experienceLevel)}</p>
          </div>
          <div>
            <p className="font-mono text-xs text-zinc-400 uppercase tracking-widest">Location</p>
            <p className="font-sans text-sm text-zinc-700">{formatValue(member.location)}</p>
          </div>
          <div>
            <p className="font-mono text-xs text-zinc-400 uppercase tracking-widest">Skills</p>
          ...
          <div>
            ...
            <p className="font-sans text-sm text-zinc-700">{formatValue(member.currentRole)}</p>
          </div>
          <div>
            <p className="font-mono text-xs text-zinc-400 uppercase tracking-widest">
              Primary Goal
            </p>
            <p className="font-sans text-sm text-zinc-700">{formatValue(member.primaryGoal)}</p>
          </div>
          <div>
            <p className="font-mono text-xs text-zinc-400 uppercase tracking-widest">
              Community Goals
        ...
        <div className="bg-white border border-red-200 p-6">
          <div className="flex items-start gap-3">
            ...
            <button
              ...
              className={`font-mono text-xs uppercase tracking-widest px-4 py-2 border transition-colors disabled:opacity-50 disabled:pointer-events-none ${
                confirmDeactivate
