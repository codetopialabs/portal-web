...
function DeleteRoleButton({ id, name }: { id: number; name: string }) {
    ...
    return (
        <button
            ...
            disabled={isPending}
            className={`font-mono text-xs uppercase tracking-widest px-3 py-1.5 border transition-colors disabled:opacity-50 disabled:pointer-events-none ${confirming
    ...
    return (
        <div className="bg-white border border-zinc-200">
            ...
            <div className="grid grid-cols-[2fr_2fr_3fr_1fr_1fr_auto] gap-4 px-4 py-3 border-b border-zinc-200 bg-zinc-50">
                ...
                <span className="font-mono text-xs text-zinc-400 uppercase tracking-widest">Display Name</span>
                <span className="font-mono text-xs text-zinc-400 uppercase tracking-widest">Description</span>
                <span className="font-mono text-xs text-zinc-400 uppercase tracking-widest">Permissions</span>
                <span className="font-mono text-xs text-zinc-400 uppercase tracking-widest">Members</span>
                <span className="font-mono text-xs text-zinc-400 uppercase tracking-widest sr-only">Actions</span>
            </div>
            ...
            {roles.map((role) => (
                ...
                >
                    ...
                    {/* Display name */}
                    <span className="font-sans text-sm text-zinc-700 truncate">
                        {role.displayName}
                    </span>
