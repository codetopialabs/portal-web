...
import { usePermissionList, useRole as useAdminRole, useUpdateRole } from "@/hooks/useAdmin";
            ...
            <div className="bg-white border border-zinc-200">
                ...
                <div className="px-6 py-6 space-y-5">
                    ...
                    <div className="space-y-1.5">
                        <Label htmlFor="name" className="font-mono text-xs text-zinc-400 uppercase tracking-widest">
                            Name (slug)
                        </Label>
                        <Input
                            id="name"
                    ...
                    {/* Display name */}
                    <div className="space-y-1.5">
                        <Label htmlFor="displayName" className="font-mono text-xs text-zinc-400 uppercase tracking-widest">
                            Display Name
                        </Label>
                        <Input
                            id="displayName"
            ...
            <div>
                <div className="mb-4">
                    ...
                    <p className="font-mono text-xs text-zinc-400 mt-1">
                        Select the permissions this role grants. Destructive permissions must be explicitly listed.
                    </p>
                </div>
...
export default function EditRolePage({ params }: { params: { id: string } }) {
    return (
        <RouteGuard permission="roles.edit">
            <DashboardShell>
                <EditRolePageContent id={params.id} />
            </DashboardShell>
        </RouteGuard>
    );
}
