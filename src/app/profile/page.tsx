...
import { User, Globe, Camera, Cpu, Plus, MapPin, X } from "lucide-react";
      ...
      <div className="max-w-6xl space-y-8 pb-20">
        ...
        <div className="flex flex-col gap-1">
          ...
          <p className="font-mono text-xs uppercase tracking-widest text-zinc-400">
            Manage your public identity and connected accounts
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white border border-zinc-200 overflow-hidden">
              <div className="aspect-video relative group">
                ...
                <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                  <button className="font-mono text-[9px] uppercase tracking-widest text-white border border-white px-4 py-2 hover:bg-white hover:text-black transition-all flex items-center gap-2">
            ...
            <div className="p-4 bg-zinc-50 border border-zinc-200">
              <p className="font-mono text-[9px] uppercase tracking-widest text-zinc-500 leading-relaxed">
          ...
          <div className="lg:col-span-2 space-y-8">
                  ...
                  <div className="relative">
                    ...
                    {showSuggestions && (suggestions.length > 0 || isLoadingLoc) && (
                      <div className="absolute top-full left-0 w-full bg-white border border-zinc-200 border-t-0 z-50 shadow-lg">
                        {isLoadingLoc ? (
                          <div className="px-4 py-3 font-mono text-[9px] uppercase tracking-widest text-zinc-400">
                            Searching...
                          </div>
                        ) : (
                          suggestions.map((loc) => (
                ...
                {[
                  ...
                  <div key={placeholder} className="flex items-center gap-3 px-4">
                    ...
                    <input
                      ...
                      className="flex-1 h-11 bg-transparent font-mono text-xs placeholder:text-zinc-300 focus:outline-none text-zinc-900"
                    />
                  </div>
                ))}
              </div>
              ...
              <div className="bg-white border border-zinc-200 p-5">
                <div className="flex flex-wrap gap-2">
                  {skills.map((skill) => (
                    <span
                      key={skill}
                      className="inline-flex items-center gap-1.5 px-3 h-8 bg-zinc-50 border border-zinc-200 font-mono text-[9px] uppercase tracking-widest text-zinc-700"
                    >
                      {skill}
                      <button
                  ...
                  {isAdding ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 h-8 border border-dashed border-zinc-300 font-mono text-[9px] uppercase tracking-widest text-zinc-400 hover:border-zinc-900 hover:text-zinc-900 transition-all"
                    >
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              <Button
                variant="outline"
                className="h-10 rounded-none border-zinc-200 font-mono text-[9px] uppercase tracking-widest px-6 hover:border-zinc-400"
              >
                Discard
              </Button>
