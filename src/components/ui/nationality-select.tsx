...
export function NationalitySelect({
    ...
    const triggerBase =
        variant === "onboarding"
            ? `h-11 w-full border bg-white px-3 font-mono text-sm text-left flex items-center justify-between transition-all focus:outline-none ${error
                ? "border-red-500"
                : open
                    ? "border-zinc-900"
                    : "border-zinc-200 focus:border-zinc-900"
            }`
            : `h-11 w-full rounded-none border bg-white px-3 font-mono text-sm text-left flex items-center justify-between transition-all focus-visible:ring-0 focus:outline-none ${error
                ? "border-red-500"
                : open
                    ? "border-zinc-900"
        ...
        <Popover open={open} onOpenChange={setOpen}>
            ...
            >
                ...
                <div className="max-h-60 overflow-y-auto" role="listbox">
                    {filtered.length === 0 ? (
                        <p className="px-3 py-4 font-mono text-xs text-zinc-400 text-center">
                            No match found
                        </p>
                    ) : (
                        filtered.map((n) => (
                            <button
                                ...
                                className={`w-full flex items-center justify-between px-3 py-2.5 text-left font-mono text-sm transition-colors ${value === n.value
