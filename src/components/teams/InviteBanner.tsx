...
function InviteRow({ invite }: { invite: TeamInvite }) {
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 py-1">
      <p className="font-mono text-xs text-text-secondary flex-1 min-w-0">
...
export function InviteBanner() {
  ...
  return (
    <div className="bg-white border-b border-grey-200 px-5 py-3 relative">
      <button
        type="button"
        onClick={dismiss}
        className="absolute right-4 top-3 text-text-muted hover:text-text-secondary transition-colors"
