    ...
    <section id="dashboard-profile-completion" className="border border-zinc-200 bg-white">
      ...
      <div className="flex items-center gap-4 px-5 py-4">
        ...
        <div className="min-w-0 flex-1">
          <p className="font-mono text-xs font-medium text-zinc-400">Missing · +{item.weight}%</p>
        ...
        <Link
          href={item.href}
          className="shrink-0 inline-flex h-8 items-center gap-2 border border-zinc-900 bg-zinc-950 px-3.5 font-mono text-sm font-medium text-white transition-colors hover:bg-zinc-800"
        >
          Fix
      ...
      <div className="flex items-center justify-between border-t border-zinc-100 px-5 py-2">
        <button
          ...
          className="inline-flex items-center gap-1.5 font-mono text-xs font-medium text-zinc-400 transition-colors hover:text-zinc-950 disabled:opacity-30"
        >
